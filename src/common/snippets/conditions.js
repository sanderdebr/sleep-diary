export default function conditionsText() {
  return (
    <section>
      ...
      <p>Welcome to SleepDiary!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of SleepDiary's Website, located at https://www.sleepdiary.nl.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use SleepDiary if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing SleepDiary, you agreed to use
        cookies in agreement with the SleepDiary's Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, SleepDiary and/or its licensors own the
        intellectual property rights for all material on SleepDiary. All
        intellectual property rights are reserved. You may access this from
        SleepDiary for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from SleepDiary</li>
        <li>Sell, rent or sub-license material from SleepDiary</li>
        <li>Reproduce, duplicate or copy material from SleepDiary</li>
        <li>Redistribute content from SleepDiary</li>
      </ul>
      ...
      <p>
        ...
        SleepDiary does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of SleepDiary,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, SleepDiary shall not be
      ...
      <p>
        SleepDiary reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant SleepDiary a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of SleepDiary; and (d) the link is
      ...
      <p>
        ...
        e-mail to SleepDiary. Please include your name, your organization name,
      ...
      <p>
        No use of SleepDiary's logo or other artwork will be allowed for linking
