export default function privacyText() {
  return (
    <section>
      <h1>Privacy Policy for SleepDiary</h1>

      <p>
        At SleepDiary, accessible from https://www.sleepdiary.nl, one of our
        main priorities is the privacy of our visitors. This Privacy Policy
        document contains types of information that is collected and recorded by
        SleepDiary and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in SleepDiary. This policy is not applicable to
      ...
      <p>
        SleepDiary follows a standard procedure of using log files. These files
      ...
      <p>
        Like any other website, SleepDiary uses 'cookies'. These cookies are
      ...
      <p>
        ...
        advertising partners of SleepDiary.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on SleepDiary, which are sent
      ...
      <p>
        Note that SleepDiary has no access to or control over these cookies that
      ...
      <p>
        SleepDiary's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        SleepDiary does not knowingly collect any Personal Identifiable
