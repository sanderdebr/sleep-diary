...
export default async (req, res) => {
  ...
  let fitbitURL = `https://www.fitbit.com/oauth2/authorize?response_type=code&client_id=${Credentials.FITBIT_CLIENT_ID}&redirect_uri=${Credentials.REDIRECT_URIS}&scope=sleep`;
